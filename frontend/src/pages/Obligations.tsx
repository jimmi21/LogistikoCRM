...
import { ClipboardList, AlertCircle, RefreshCw, Filter, Plus, Edit2, Trash2 } from 'lucide-react';
  ...
  return (
    <div className="space-y-6">
                  ...
                  <tbody className="bg-white divide-y divide-gray-200">
                    {filteredObligations.map((obligation) => (
                      <tr key={obligation.id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap">
                          <span className="inline-flex px-2.5 py-1 text-sm font-medium bg-gray-100 text-gray-800 rounded">
                            {obligation.type_name || obligation.obligation_type}
                          </span>
                        </td>
      ...
      <ConfirmDialog
        ...
        message={`Είστε σίγουροι ότι θέλετε να διαγράψετε την υποχρέωση ${selectedObligation?.type_name || selectedObligation?.obligation_type} για ${selectedObligation?.client_name || 'τον πελάτη'};`}
