...
/**
 * Get reusable obligation profile bundles
 */
export function useObligationProfileBundles() {
  return useQuery({
    queryKey: ['obligation-profile-bundles'],
    queryFn: async () => {
...
/**
 * Generate monthly obligations from client profiles
 */
